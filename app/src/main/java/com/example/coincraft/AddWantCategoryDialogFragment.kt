...
class AddWantCategoryDialogFragment: DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_add_want_category_dialog, container, false)
        ...
        amountLimit = view.findViewById(R.id.txt_want_amount)
    ...
    private fun saveBudget() {
        ...
        budgetViewModel.addBudgetWants(userId, budget) { success, error ->
            if (success) {
